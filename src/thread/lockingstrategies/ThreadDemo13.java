package thread.lockingstrategies;
/**
 commented because javafx sdk is not installed

// ReentrantLock - User Interface Application example
...
public class ThreadDemo13 extends Application {
